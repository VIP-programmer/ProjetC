...
donnees* creerAdherent(char *nom_adh,char *prenom_adh,char *adresse_email,char *adresse_personnelle);//la création d'une nouvel adhèrent
donnees* cpyAdherent(int num,char *nom_adh,char *prenom_adh,char *adresse_email,char *adresse_personnelle,int nbre_emprunts_adh);//la Copier de les informations de l'adhérents
...
void modifierAdherent(int num,listeAdherents tete,char *nom_adh,char *prenom_adh,char *adresse_email,char *adresse_personnelle);//la odification des information d'un adhrant
...
listeAdherents supprimerAdherent(int num,listeAdherents tete);//la supresion d'un adhrant de la liste
